...
VALUES
	...
	('solo', 'han', 'solo', 'TA'),
	('napoleon', 'napoleon', 'bonaparte', 'instructor');
...
VALUES
	...
	(1, 'git+group_6_1'), -- group 6
	(1, 'git+group_7_1'), -- group 7
	(1, 'git+group_8_1'), -- group 8
	(1, 'git+group_9_1'), -- group 9
	(1, 'git+group_10_1'), -- group 10
	(1, 'git+group_11_1'), -- group 11
	-- A2 - 11 groups
	(2, 'git+group_11_2'),
	(2, 'git+group_12_2'),
	(2, 'git+group_13_2'),
